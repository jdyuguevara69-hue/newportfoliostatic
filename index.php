<?php
// Static portfolio page. No Laravel, database, Composer, or build step required.
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="projects">
                ...
                <div class="project-card">
                    ...
                    <p>
                       My portfolio uses Laravel and much easier just to show to everyone the static version of it.
                    </p>
                    ...
                    <div class="project-actions">
                        <a
                            href="https://github.com/jdyuguevara69-hue/portfolio"
                            class="project-link github"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
